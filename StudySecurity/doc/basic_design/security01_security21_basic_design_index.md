...
| security13 | `../requirements/security13_local_https_requirements.md` | `security13_basic_design.md` |
| security14 | `../requirements/security14_nginx_https_termination_requirements.md` | `security14_basic_design.md` |
| security15 | `../requirements/security15_security_headers_requirements.md` | `security15_basic_design.md` |
| security16 | `../requirements/security16_audit_log_requirements.md` | `security16_basic_design.md` |
...
2026-05-07 に `StudySecurity/doc/detailed_design/` へ `security21` の詳細設計を追加した。
