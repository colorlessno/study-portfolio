...
この文書は、各`StudyXX`をポートフォリオと学習教材の両面から改善する順番を決めるための現在地です。個々のテーマを探す場合は[テーマカタログ](./THEME_CATALOG.md)、学習方法は[学習再開ガイド](./LEARNING_GUIDE.md)、将来の管理ツール構想は[Study Hub 将来構想](./STUDY_HUB_ROADMAP.md)、周囲との意味や関連性がずれる可能性がある事項は[保留課題一覧](./DEFERRED_WORK.md)を参照します。
...
- StudyAIは外部LLM・DB不要のsystem17〜30へ学習ノートと自動検証を追加した。
...
| StudyAI | 48 | 19 | 574 | 58 | 4つの推奨経路を定義し、system17〜30の基礎・品質観察テーマに学習ノートと外部依存なしの検証を追加した | system31〜36の評価・traceと、system03のRAG実アプリを順に改善する |
...
- 2番目の単位としてsystem23〜30へ、検索再順位付け、model・出力設定比較、量子化、VLM、OCR、metadata、重複検出の品質観察を追加した。
...
- 次はsystem31〜36の評価・traceと、system03を含むRAG実アプリ経路を小さい単位で改善する。
...
6. 現在範囲外の意味・関連性・責務・名称のずれを見つけた場合は、黙って広範囲を変更せず、[保留課題一覧](./DEFERRED_WORK.md)へ記録する。
