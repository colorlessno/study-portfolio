...
| actor | 目的 | 証拠 |
| --- | --- | --- |
| learner | health と readiness の違いを理解する | `StudyDevOps/doc/learning_notes/devops07_health_check_endpoint/README.md` |
| Docker | containerのhealthを判断する | `StudyDevOps/src/apps/devops07_health_check_endpoint/docker-compose.yml` |
| smoke test | endpointの動作を確認する | `StudyDevOps/src/apps/devops07_health_check_endpoint/tests/health.test.js` |
