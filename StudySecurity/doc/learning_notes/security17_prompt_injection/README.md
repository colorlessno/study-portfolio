...
```powershell
npm.cmd --prefix StudySecurity/src/backend/src/studysecurity/systems/security17_prompt_injection run check
npm.cmd --prefix StudySecurity/src/backend/src/studysecurity/systems/security17_prompt_injection run demo
npm.cmd --prefix StudySecurity/src/backend/src/studysecurity/systems/security17_prompt_injection run start
```
