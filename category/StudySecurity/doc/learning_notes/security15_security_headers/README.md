...
```powershell
npm.cmd --prefix category/StudySecurity/src/backend/src/studysecurity/systems/security15_security_headers run check
npm.cmd --prefix category/StudySecurity/src/backend/src/studysecurity/systems/security15_security_headers run start
```
