...
```powershell
npm.cmd --prefix category/StudyDevOps/src/apps/devops02_lint_unit_test ci
npm.cmd --prefix category/StudyDevOps/src/apps/devops02_lint_unit_test run lint
npm.cmd --prefix category/StudyDevOps/src/apps/devops02_lint_unit_test test
```
