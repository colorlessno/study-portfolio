...
| drafted | mock decision completed | optimized | decision_generated |
| optimized | risk found | violation_found | risk_flagged |
| optimized | no blocking risk | accepted | execution_completed |
...
| error_code | HTTP | 条件 |
|---|---|---|
| system43_not_found | 404 | catalog に system定義がない |
| system43_input_invalid | 400 | input がobject ではない |
| system43_unsafe_input_masked | 200 | 秘密情報相当の入力を mask して続行した |
| system43_execution_failed | 500 | 想定外例外 |
...
python .\src\scripts\system43_enterprise_demo.py
