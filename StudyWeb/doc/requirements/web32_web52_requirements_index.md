...
2026-05-07 に `StudyWeb/doc/basic_design/` へ `web52` の基本設計を追加し、`web32`〜`web52` の基本設計インデックスへ更新した。
同日に `StudyWeb/doc/detailed_design/` へ `web52` の詳細設計を作成した。
同日に `StudyWeb/doc/learning_notes/web52_modern_rendering_comparison/` を作成した。
