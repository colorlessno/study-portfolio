...
```powershell
npm.cmd --prefix category/StudySecurity/src/backend/src/studysecurity/systems/security16_dependency_management run check
npm.cmd --prefix category/StudySecurity/src/backend/src/studysecurity/systems/security16_dependency_management run demo
```
