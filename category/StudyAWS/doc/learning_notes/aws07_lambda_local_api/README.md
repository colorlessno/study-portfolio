...
```powershell
node category/StudyAWS\scripts\validate-studyaws.mjs aws07
npm --prefix category/StudyAWS\src\backend\src\studyaws\systems\aws07_lambda_local_api run invoke
```
...
```powershell
sam local invoke HelloFunction -t category/StudyAWS\src\infra\aws07_lambda_local_api\template.yaml -e category/StudyAWS\src\backend\src\studyaws\systems\aws07_lambda_local_api\events\hello.json
```
