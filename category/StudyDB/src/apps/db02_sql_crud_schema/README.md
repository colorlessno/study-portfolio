...
category/StudyDB\src\apps\common\scripts\run-sql.cmd db02 sql\003_crud_examples.sql
category/StudyDB\src\apps\common\scripts\run-sql.cmd db02 sql\004_join_examples.sql
```
...
停止時は `docker compose -f category/StudyDB\src\apps\common\docker-compose.yml down` を実行します。
