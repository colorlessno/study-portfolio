...
```powershell
node category/StudyAWS\scripts\validate-studyaws.mjs aws03
```

Dockerで観察する場合:

```powershell
docker build -t studyaws-aws03 category/StudyAWS\src\backend\src\studyaws\systems\aws03_ec2_ssh
