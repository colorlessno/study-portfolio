...
```powershell
node StudyBase\scripts\validate-studybase.mjs base09
```

個別に実行する場合:

```powershell
npm --prefix StudyBase\src\samples\base09_npm_scripts\sample_node_project run dev
npm --prefix StudyBase\src\samples\base09_npm_scripts\sample_node_project run build
npm --prefix StudyBase\src\samples\base09_npm_scripts\sample_node_project test
npm --prefix StudyBase\src\samples\base09_npm_scripts\sample_node_project start
```
