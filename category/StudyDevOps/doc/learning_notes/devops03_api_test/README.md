...
```powershell
docker compose -f category/StudyDevOps/src/apps/devops03_api_test/docker-compose.yml up --build --abort-on-container-exit --exit-code-from test
docker compose -f category/StudyDevOps/src/apps/devops03_api_test/docker-compose.yml down --volumes
```
