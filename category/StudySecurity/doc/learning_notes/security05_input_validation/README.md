...
```powershell
npm.cmd --prefix category/StudySecurity/src/backend/src/studysecurity/systems/security05_input_validation run check
npm.cmd --prefix category/StudySecurity/src/backend/src/studysecurity/systems/security05_input_validation test
npm.cmd --prefix category/StudySecurity/src/backend/src/studysecurity/systems/security05_input_validation run demo
```
