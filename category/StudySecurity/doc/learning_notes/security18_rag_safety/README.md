...
```powershell
npm.cmd --prefix category/StudySecurity/src/backend/src/studysecurity/systems/security18_rag_safety run check
npm.cmd --prefix category/StudySecurity/src/backend/src/studysecurity/systems/security18_rag_safety run demo
npm.cmd --prefix category/StudySecurity/src/backend/src/studysecurity/systems/security18_rag_safety run start
```
